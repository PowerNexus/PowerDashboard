...
- **Déploiement** : images taguées par SHA, déploiement bleu/vert du panel. Montée de version de Wings par node, après passage des tests de contrat en préproduction, jamais en masse.
