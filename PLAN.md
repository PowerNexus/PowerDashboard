...
Posées avant la phase 1, relues à la fin de la V1 (septembre 2026) contre le code, qui fait foi. Toutes sont tranchées. Une appelle encore du travail avant l'étiquette `v1.0.0` : la 4, un bouton à livrer.
